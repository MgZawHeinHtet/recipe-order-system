        ...
        <div style="clear: both;">
            <table   class="w-full text-left">
                <thead class="border-b-4 border-black">
                    <tr>
                        <th style="text-align: left" colspan="4" class="text-gray-700 uppercase py-4 text-lg">Details</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="border-b-2 border-gray-400">
                        ...
                        <td style="padding: 1rem;text-align: center;border-left:1px solid black " class="py-2 px-2 border-x-2 border-gray-400 text-center">${{ $product->product->price }}</td>
                        <td style="padding: 1rem;text-align: center;border-left: 1px solid black" class="py-2 px-2  border-x-2 border-gray-400 text-center">{{ $product->quantity }}</td>
                        <td style="padding: 1rem;text-align: right;border-left: 1px solid black" class="py-2 text-right">${{ $product->total }}</td>
                    </tr>
                    @endforeach
                ...
                <tfoot  class="border-t-4 border-black" >
                    <tr >
                        <td></td>
                        <td></td>
                        <td style="border-left: 1px solid black;text-align: center" class="py-1 px-2 border-r-2 border-gray-400 text-center text-semibold uppercase">Total</td>
                        <td style="border-left: 1px solid black;text-align: right" class="py-1 text-right font-bold text-lg">${{ $products->sum('total') }}</td>
                    </tr>
                </tfoot>
            </table>
        </div>
